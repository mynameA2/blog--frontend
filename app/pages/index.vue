<template>
  <section class="max-w-3x1 mx-auto space-y-6">
    <div class="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
      ...
      <NuxtLink
        to="/create"
        class="inline-flex justify-center rounded-md border bg-gray-500 px-4 py-2 text-black hover:opacity-80"
      >
        Create Post
      </NuxtLink>
    </div>
    ...
    <p v-if="!filteredPosts.length" class="text-gray-500 text-center">No posts found.</p>
